...
describe("Activity Model", () => {
    ...
    it("should not create an invalid element", (done) => {
        var group = new Activity(activities.secondActNoScoreNoDesc);
    ...
    it("should update the element", (done)=> {
        Activity.filter({
            ...
            .then((result) => {
                ...
                result[0].name = activities.newSecondAct.name;
                result[0].badge = activities.newSecondAct.badge;
                result[0].score = activities.newSecondAct.score;
                result[0].description = activities.newSecondAct.description;
