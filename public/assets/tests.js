...
define('peas/tests/components/activity-list.jshint', ['exports'], function (exports) {
  'use strict';

  QUnit.module('JSHint - components');
  QUnit.test('components/activity-list.js should pass jshint', function (assert) {
    assert.expect(1);
    assert.ok(false, 'components/activity-list.js should pass jshint.\ncomponents/activity-list.js: line 2, col 8, \'_\' is defined but never used.\n\n1 error');
  });
});
...
define('peas/tests/components/user-info.jshint', ['exports'], function (exports) {
  'use strict';

  QUnit.module('JSHint - components');
  QUnit.test('components/user-info.js should pass jshint', function (assert) {
    assert.expect(1);
...
define('peas/tests/integration/components/activity-list-test', ['exports', 'ember-qunit'], function (exports, _emberQunit) {

  (0, _emberQunit.moduleForComponent)('activity-list', 'Integration | Component | activity list', {
    integration: true
  });
  ...
  (0, _emberQunit.test)('it renders', function (assert) {
    ...
    this.render(Ember.HTMLBars.template((function () {
      return {
        ...
        statements: [['content', 'activity-list', ['loc', [null, [1, 0], [1, 17]]]]],
        locals: [],
        templates: []
      };
    })()));
    ...
    this.render(Ember.HTMLBars.template((function () {
      ...
      return {
        ...
        statements: [['block', 'activity-list', [], [], 0, null, ['loc', [null, [2, 4], [4, 22]]]]],
        locals: [],
        templates: [child0]
      };
    })()));
...
define('peas/tests/integration/components/activity-list-test.jshint', ['exports'], function (exports) {
  'use strict';

  QUnit.module('JSHint - integration/components');
  QUnit.test('integration/components/activity-list-test.js should pass jshint', function (assert) {
    assert.expect(1);
    assert.ok(true, 'integration/components/activity-list-test.js should pass jshint.');
  });
});
...
define('peas/tests/integration/components/user-info-test', ['exports', 'ember-qunit'], function (exports, _emberQunit) {
...
define('peas/tests/integration/components/user-info-test.jshint', ['exports'], function (exports) {
  'use strict';

  QUnit.module('JSHint - integration/components');
  QUnit.test('integration/components/user-info-test.js should pass jshint', function (assert) {
    assert.expect(1);
